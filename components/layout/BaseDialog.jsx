    ...
    <Dialog open={open} onOpenChange={onCancel}>
      <DialogContent
        ...
        <DialogHeader className="flex-row items-center justify-between">
          ...
          <DialogClose asChild>
            <button
              className="hover:bg-grey-900 inline-flex size-6 cursor-pointer appearance-none items-center justify-center rounded-full transition-colors hover:text-white"
